...
import type { Categories, NewCategory, NewProducts } from '../../types'
...
function Index() {
  ...
  const createProductRequest = trpc.useMutation('products.createProduct')
